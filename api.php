...
// THAY BẰNG ĐOẠN CURL NÀY:
$renderUrl = "https://tracuumst.onrender.com/api?mst=" . urlencode($mst);

$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $renderUrl);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_TIMEOUT, 60); // Đợi tối đa 60s cho Puppeteer cào dữ liệu
